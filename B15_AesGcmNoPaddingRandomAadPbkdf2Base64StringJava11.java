...
public class B15_AesGcmNoPaddingRandomAadPbkdf2Base64StringJava11 {
	...
	public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException,
		...
		System.out.println("passwordSaltByte (hex)          :" + printHexBinary(passwordSaltByte));
		System.out.println("passwordHashByte (hex)          :" + " * * * Das Byte Array wurde gelöscht * * *");
		System.out.println("aadtextString                   :" + aadtextString);
		System.out.println("aadtextByte (hex)               :" + printHexBinary(aadtextByte));
		...
		System.out.println(
				"gcmCompleteCiphertextByte (hex) :" + printHexBinary(gcmCompleteCiphertextByte));
		...
		System.out.println("gcmCompleteCiphertextByteReceived:"
				+ printHexBinary(gcmCompleteCiphertextByteReceived));
		System.out
				.println("aadtextByte (hex)                :" + printHexBinary(aadtextByteReceived));
		...
		System.out.println("gcmCompleteCiphertextByteR (hex) :"
				+ printHexBinary(gcmCompleteCiphertextByteReceived));
		System.out.println(
				"passwordSaltByte Received        :" + printHexBinary(passwordSaltByteReceived));
		System.out.println("passwordHashByteDecrypt          :" + " * * * Das Byte Array wurde gelöscht * * *");
		System.out
				.println("gcmNonceByteReceived (hex)       :" + printHexBinary(gcmNonceByteReceived));
		System.out.println(
				"ciphertextByteReceived (hex)     :" + printHexBinary(ciphertextByteReceived));
