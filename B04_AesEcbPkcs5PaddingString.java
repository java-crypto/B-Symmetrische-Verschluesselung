...
public class B04_AesEcbPkcs5PaddingString {

	public static void main(String[] args) throws UnsupportedEncodingException, NoSuchAlgorithmException, 
			NoSuchPaddingException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
		System.out.println("B04 AES im Betriebsmodus ECB PKCS5Padding mit einem String");
		// es werden ein paar variablen benötigt:
		String plaintextString = "HalloWelt012345"; // exakt 16 zeichen
